...
class Env(BaseSettings):
    ...
    TRAFFIC_CONTRACT_FAIL_OPEN_ON_REDIS_ERROR: bool = False

    # 0 means no cap enforced; still records per-feature counters.
    TOTAL_TRAFFIC_CONTRACT_RPM_LIMIT: int = 0
    TOTAL_TRAFFIC_CONTRACT_TPM_LIMIT: int = 0

    FEATURE_SMART_WINDOW: str = "smart-window"
    SMART_WINDOW_TRAFFIC_CONTRACT_RPM_LIMIT: int = 10_000
    SMART_WINDOW_TRAFFIC_CONTRACT_TPM_LIMIT: int = 1_000_000

    FEATURE_S2S: str = "s2s"
    S2S_TRAFFIC_CONTRACT_RPM_LIMIT: int = 10_000
    S2S_TRAFFIC_CONTRACT_TPM_LIMIT: int = 1_000_000

    FEATURE_S2S_ANDROID: str = "s2s-android"
    S2S_ANDROID_TRAFFIC_CONTRACT_RPM_LIMIT: int = 10_000
    S2S_ANDROID_TRAFFIC_CONTRACT_TPM_LIMIT: int = 1_000_000
