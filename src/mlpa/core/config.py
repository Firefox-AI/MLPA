...
ERROR_CODE_FASTLY_SIGNAL_TRIGGERED: int = 7
            ...
            "application/json": {
                "schema": {
                    ...
                    "properties": {
                        "error": {
                            "type": "integer",
                            "description": f"Error code: {ERROR_CODE_FASTLY_SIGNAL_TRIGGERED} for fastly signal triggered (edge; not from MLPA)",
                        }
                    },
                    "required": ["error"],
                },
                "examples": {
                    "fastly_signal_triggered": {
                        "summary": "Fastly signal triggered",
                        "value": {"error": ERROR_CODE_FASTLY_SIGNAL_TRIGGERED},
                        "description": "Fastly signal triggered.",
                    }
                },
            }
        },
                ...
                "schema": {
                    ...
                    "properties": {
                        "error": {
                            "type": "integer",
                            "description": (
                                f"Error code: {ERROR_CODE_BUDGET_LIMIT_EXCEEDED} budget limit exceeded, "
                                f"{ERROR_CODE_RATE_LIMIT_EXCEEDED} rate limit (TPM/RPM), "
                                f"{ERROR_CODE_UPSTREAM_RATE_LIMIT_EXCEEDED} upstream provider rate limit, "
                                f"{ERROR_CODE_FASTLY_WAF_RATE_LIMIT} Fastly WAF rate limit (edge; not from MLPA)",
                            ),
                        }
                    },
                    "required": ["error"],
            ...
            "application/json": {
                "schema": {
                    ...
                    "properties": {
                        "error": {
                            "type": "integer",
                            "description": f"Error code: {ERROR_CODE_REQUEST_TOO_LARGE} for request/context too large",
                        }
                    },
                    "required": ["error"],
                },
            ...
            "application/json": {
                "schema": {
                    ...
                    "properties": {
                        "error": {
                            "type": "integer",
                            "description": f"Error code: {ERROR_CODE_MAX_USERS_REACHED} for maximum signed-in users reached",
                        }
                    },
                    "required": ["error"],
                },
