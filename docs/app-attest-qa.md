...
- **Apple App Attest Documentation**: [Apple Developer - App Attest](https://developer.apple.com/documentation/devicecheck/validating_apps_that_connect_to_your_server)
- **Apple App Attest API Reference**: [DCAppAttestService](https://developer.apple.com/documentation/devicecheck/dcappattestservice)
- **Apple App Attest WWDC Sessions**:
  - [WWDC 2020 - App Attest](https://developer.apple.com/videos/play/wwdc2020/10677/)
  - [WWDC 2021 - App Attest Updates](https://developer.apple.com/videos/play/wwdc2021/10133/)

### Standards and Specifications

- **WebAuthn Specification**: [W3C Web Authentication (WebAuthn)](https://www.w3.org/TR/webauthn-2/) - App Attest is based on WebAuthn
- **FIDO2 CTAP2**: [Client to Authenticator Protocol](https://fidoalliance.org/specs/fido-v2.0-ps-20190130/fido-client-to-authenticator-protocol-v2.0-ps-20190130.html) - Underlying protocol
- **CBOR Specification**: [RFC 7049 - Concise Binary Object Representation](https://tools.ietf.org/html/rfc7049) - Data format used for attestation/assertion objects
- **COSE Specification**: [RFC 8152 - CBOR Object Signing and Encryption](https://tools.ietf.org/html/rfc8152) - Public key format in attestation objects

### Libraries

- **pyattest**: [GitHub - pyattest](https://github.com/mozilla/pyattest) - Python library for verifying App Attest attestations and assertions
- **PyJWT**: [PyJWT Documentation](https://pyjwt.readthedocs.io/) - JWT token encoding/decoding
- **cryptography**: [cryptography.io](https://cryptography.io/) - Cryptographic primitives for key generation and signing
- **cbor2**: [cbor2 Documentation](https://cbor2.readthedocs.io/) - CBOR encoding/decoding

### Related Resources

- **WebAuthn.io**: [WebAuthn.io](https://webauthn.io/) - Interactive WebAuthn demo and explanation
- **FIDO Alliance**: [FIDO Alliance](https://fidoalliance.org/) - Standards organization behind FIDO2/WebAuthn
