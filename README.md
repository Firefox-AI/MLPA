...
| **P50/P90/P99 tokens per request** | `histogram_quantile(0.50, sum by (le) (rate(mlpa_chat_tokens_per_request_bucket{type="prompt"}[5m])))` for prompt; use `type="completion"` for completion tokens (use 0.90, 0.99 for P90/P99) |
